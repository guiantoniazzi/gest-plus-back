        ...
        async (req: Request, res: Response): Promise<any> => {
          try {
            ...
            if (!empresaSelecionada || isNaN(empresaSelecionada)) {
              return res
                .status(400)
                .json({ message: "Informe a empresa selecionada" });
            }
      ...
      this.router.get(
        ...
        async (req: Request, res: Response): Promise<any> => {
          try {
            ...
            const pessoas = await this.pessoasService.getPessoasAdm();
      ...
      this.router.get(
        ...
        async (req: Request, res: Response): Promise<any> => {
          try {
            ...
            const pessoas = await this.pessoasService.getEmpresasAdm();
            res.setHeader("cache-control", "no-store");
            return res.status(200).json(pessoas);
          } catch (error) {
            return res.status(500).json({ message: "Erro ao buscar pessoas" });
      ...
      this.router.get(
        ...
        async (req: Request, res: Response): Promise<any> => {
          try {
            ...
            const clientes = await this.pessoasService.getPessoas(
              token,
              empresaSelecionada,
              false,
              false,
        ...
        async (req: Request, res: Response): Promise<any> => {
          try {
            ...
            if (!idCliente || isNaN(idCliente)) {
              return res
                .status(400)
                .json({ message: "Informe a empresa cliente" });
            }
